...
const corsOptions = {
  origin: ['http://localhost:8556', 'https://savefromyt.akwebsolution.in', 'https://live-counter-ef31e.web.app', 'https://live-counter-ef31e.firebaseapp.com'],
...
app.get('/watch', async (req, res) => {
  ...
  try {
    ...
    ytdl(url, { filter: format === ".mp3" ? "audioonly" : "video", format, ...reqOptions })
